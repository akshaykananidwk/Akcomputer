...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if (!$hasRoles) {
            ...
            $ins->execute(['Accounts', $mk(['dashboard.view','sales.view','sales.all','purchases.view','purchases.all','payments.view','payments.add','payments.delete','parties.view','reports.view','reports.gst']), 1]);
