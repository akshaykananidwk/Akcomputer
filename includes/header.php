...
$_navMenu = [
    ...
    ['group', 'parties', 'users', 'Parties', [
        ...
        ['campaigns.php', '📣 કેમ્પેન (Campaigns)', 'campaigns.view', 'campaigns.php?action=new', 'campaigns.add'],
    ]],
    ...
    ['group', 'purchase', 'box', 'Purchase', [
        ...
        ['purchase_intel.php', '🛒 શું મંગાવવું (Purchase Intelligence)', 'purchases.view', null, null],
    ...
    ['group', 'reports', 'bar-chart', 'Reports', [
        ...
        ['forecast.php', '🔮 આગળ શું દેખાય છે (Forecast)', 'reports.view', null, null],
