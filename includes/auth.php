...
function permission_labels() {
    return [
        ...
        'weborders' => 'Website Orders', 'webcustomers' => 'Dealer Website Logins (B2B)', 'netconn' => 'Internet Connections', 'amc' => 'AMC / Recurring Billing',
